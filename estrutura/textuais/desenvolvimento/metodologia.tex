...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \label{fig:delaunay2}
    \end{subfigure}
    \fonte{\cite{piteri2007triangulacao}.}
    \label{fig:delaunay}
\end{figure}
